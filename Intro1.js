  ...
  return (
    <View style={styles.introduction}>
      <View style={[styles.tabBar, styles.barLayout]}>
        ...
        >
          <Text style={styles.skip1FlexBox}>Skip</Text>
        </Pressable>
        <Pressable
      ...
      />
      <Text style={[styles.discover, styles.time1Clr]}>Discover</Text>
      <Text style={[styles.findNewPlaces, styles.skip1FlexBox]}>
        Find new places and opportunities to make new discovery !
      </Text>
